...
class _GardenSingleState extends State<GardenSingle> {
  ...
  void openGarden(Garden garden, CustomUser user) {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => ListOfPlants(user: user, garden: garden)));
  }
  ...
  void editGarden(Garden garden, CustomUser user) {
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => EditGarden(garden: garden, user: user)));
  }
  ...
  void deleteGarden(String gardenId, CustomUser user) async {
    try {
      ...
      UtilService.showError(
          'Unable to delete Garden', 'Please try again later');
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (Garden.checkItemName(widget.garden.icon)) {
      stringOfImageName =
          'assets/images/garden_backgrounds/${widget.garden.icon}.jpg'; // Selected picture
      ...
      try {
        ...
        imageAsWidget =
            const AssetImage('assets/images/garden_backgrounds/one.jpg'); // One
      }
    } else {
      imageAsWidget =
          const AssetImage('assets/images/garden_backgrounds/one.jpg'); // One
        ...
        child: Card(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(8.0),
                  image:
                      DecorationImage(image: imageAsWidget, fit: BoxFit.cover)),
