...
class CustomCupertinoContextMenu extends StatefulWidget {
  const CustomCupertinoContextMenu(
      {Key? key, required this.actionItems, required this.child})
      : super(key: key);
...
class _CustomCupertinoContextMenuState
    extends State<CustomCupertinoContextMenu> {
  @override
  Widget build(BuildContext context) {
    return CupertinoContextMenu(
        child: widget.child, actions: widget.actionItems);
  }
}
