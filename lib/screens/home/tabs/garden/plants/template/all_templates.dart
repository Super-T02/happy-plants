...
class Templates {
  ...
  static getAllTemplates(String gardenID) {
    ...
    allTemplates.add(Plant(
      ...
      icon: 'bonsai',
      watering: Watering(
          interval: PeriodsHelper.getPeriodsFromString('weekly'),
          startDate: DateTime.now(),
          waterAmount: 100),
      plantSize: PlantSize(begin: 20, now: 25),
      fertilize: Fertilize(
          interval: PeriodsHelper.getPeriodsFromString('monthly'),
          startDate: DateTime.now(),
          amount: 20),
      ...
      repot: IntervalDateTime(
          interval: PeriodsHelper.getPeriodsFromString('yearly'),
          startDate: DateTime.now()),
