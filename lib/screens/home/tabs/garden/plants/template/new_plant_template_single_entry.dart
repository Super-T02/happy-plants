...
class NewPlantTemplateSingleEntry extends StatefulWidget {
  ...
  @override
  State<NewPlantTemplateSingleEntry> createState() =>
      _NewPlantTemplateSingleEntryState();
}

class _NewPlantTemplateSingleEntryState
    extends State<NewPlantTemplateSingleEntry> {
  @override
