...
class ViewPlant extends StatefulWidget {
  const ViewPlant(
      {Key? key, required this.user, required this.garden, required this.plant})
      : super(key: key);
        ...
        body: ListView(
          ...
          children: <Widget>[
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: imageAsWidget, fit: BoxFit.cover)),
                )),
            ...
            CustomListGroup(title: 'Plant Size', children: <Widget>[
              CustomListRow(
                  title: 'Begin',
                  data: widget.plant.plantSize?.begin.toString(),
                  unit: 'cm'),
              CustomListRow(
                  title: 'Now',
                  data: widget.plant.plantSize?.now.toString(),
                  unit: 'cm'),
              CustomListRow(
                  title: 'Pot Size',
                  data: SizeHelper.getFullNameFromSize(widget.plant.potSize))
            ]),
            ...
            CustomListGroup(title: 'Watering', children: <Widget>[
              CustomListRow(
                  title: 'Amount',
                  data: widget.plant.watering?.waterAmount.toString(),
                  unit: 'ml'),
              CustomListRow(
                  title: 'Interval',
                  data: PeriodsHelper.getStringFromPeriod(
                      widget.plant.watering?.interval)),
              CustomListRow(
                  title: 'Last Time',
                  data: Util.getStringFromDateTime(
                      widget.plant.watering?.startDate))
            ]),
            ...
            CustomListGroup(title: 'Spray Plants', children: <Widget>[
              CustomListRow(
                  title: 'Interval',
                  data: PeriodsHelper.getStringFromPeriod(
                      widget.plant.spray?.interval)),
              CustomListRow(
                  title: 'Last Time',
                  data: Util.getStringFromDateTime(
                      widget.plant.spray?.startDate)),
            ...
            CustomListGroup(title: 'Fertilize', children: <Widget>[
              CustomListRow(
                  title: 'Amount',
                  data: widget.plant.fertilize?.amount.toString(),
                  unit: 'mg'),
              CustomListRow(
                  title: 'Interval',
                  data: PeriodsHelper.getStringFromPeriod(
              ...
              CustomListRow(
                  title: 'Last Time',
                  data: Util.getStringFromDateTime(
                      widget.plant.fertilize?.startDate))
            ]),
            ...
            CustomListGroup(title: 'Environment', children: <Widget>[
              CustomListRow(
                  title: 'Temperature',
                  data: widget.plant.temperature.toString(),
                  unit: '°C'),
              CustomListRow(
                  title: 'Sun-need',
                  data: SizeHelper.getFullNameFromSize(widget.plant.sunDemand)),
            ]),
            ...
            CustomListGroup(title: 'Repot', children: <Widget>[
              CustomListRow(
                  title: 'Interval',
                  data: PeriodsHelper.getStringFromPeriod(
                      widget.plant.repot?.interval)),
              CustomListRow(
                  title: 'Last Time',
                  data:
                      Util.getStringFromDateTime(widget.plant.repot?.startDate))
            ]),
            ...
            CustomListGroup(title: 'Dust Off', children: <Widget>[
              CustomListRow(
                  title: 'Interval',
                  data: PeriodsHelper.getStringFromPeriod(
                      widget.plant.dustOff?.interval)),
              CustomListRow(
                  title: 'Last Time',
                  data: Util.getStringFromDateTime(
                      widget.plant.dustOff?.startDate))
            ]),
